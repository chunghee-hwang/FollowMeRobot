...
//                break;
    ...
    if (rssiThreshold <= mRssis[0] && rssiThreshold <= mRssis[1]) {
        ...
        prevCommand = STOP;
        return;
    } else if (rssiThreshold > mRssis[0] && rssiThreshold > mRssis[1]) {
...
//            return;
//
//        } else if (rssiThreshold <= mRssis[1] && rssiThreshold <= mRssis[2]) {
//            m.getBluetoothComm().sendMessage(STOP);
//            prevCommand = STOP;
//            return;
//        } else if (rssiThreshold <= mRssis[0] && rssiThreshold <= mRssis[2]) {
//            m.getBluetoothComm().sendMessage(STOP);
//            prevCommand = STOP;
//            return;
//
