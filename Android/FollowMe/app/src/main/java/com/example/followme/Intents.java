...
public class Intents {
    ...
    Intents(Context context){
        ...
        colorpickerIntent = new Intent(context, ColorpickerActivity.class);
        ...
        colorpickerIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
    }
